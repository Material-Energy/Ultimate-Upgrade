...
public class MoltenProjectileEntityRenderer<M extends MoltenProjectileEntity> extends ProjectileEntityRenderer<MoltenProjectileEntity> {
    ...
    public MoltenProjectileEntityRenderer(EntityRendererFactory.Context ctx) {
        super(ctx);
    }
    ...
    @Override
    public Identifier getTexture(MoltenProjectileEntity entity) {
        return TEXTURE;
    }
}