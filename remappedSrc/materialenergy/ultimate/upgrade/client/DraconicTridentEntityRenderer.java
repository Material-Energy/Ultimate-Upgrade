...
public class DraconicTridentEntityRenderer<M extends Entity> extends EntityRenderer<DraconicTridentEntity> {
    public static final Identifier TEXTURE = new Identifier("ultimateupgrade","textures/entity/draconic_trident.png");
    private final TridentEntityModel model;

    public DraconicTridentEntityRenderer(EntityRendererFactory.Context context) {
        super(context);
