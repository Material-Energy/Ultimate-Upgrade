...
public class DraconicTotemRecipe extends BaseEnderRecipe {


    public DraconicTotemRecipe(Identifier id) {
        super(id);
    }
    ...
    public ItemStack craft(CraftingInventory inventory) {
        ItemStack itemStack = UUItems.DRACONIC_TOTEM.getDefaultStack();
