...
public class UUItems {
    ...
    public static final Item DRACONIAN_CRYSTAL = register("draconian_crystal", new Item(new FabricItemSettings().group(UltimateUpgrade.UU_MAIN)));
    public static final Item DRACONIAN_TRIDENT = register("draconic_trident", new DraconicTrident(new FabricItemSettings().group(UltimateUpgrade.UU_MAIN).maxDamage(3000)));
