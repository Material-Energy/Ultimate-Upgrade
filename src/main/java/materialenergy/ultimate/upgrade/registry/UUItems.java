...
import materialenergy.ultimate.upgrade.item.storm.VortexTridentItem;
...
public class UUItems {
    ...
    public static final Item MOLTEN_SWORD = register("molten_sword",new SwordItem(Materials.MoltenToolMaterial.INSTANCE, 3, -2.4f, new FabricItemSettings().group(UltimateUpgrade.UU_MAIN).fireproof()));
    ...
    public static final Item VORTEX_TRIDENT = register("vortex_trident", new VortexTridentItem(new FabricItemSettings().group(UltimateUpgrade.UU_MAIN).maxDamage(1000)));
