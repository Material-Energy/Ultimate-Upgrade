...
import materialenergy.ultimate.upgrade.item.draconic.*;
import materialenergy.ultimate.upgrade.item.molten.MoltenBowItem;
import materialenergy.ultimate.upgrade.item.CustomPickaxeItem;
...
public class UUItems {
    ...
    public static final Item MOLTEN_SHOVEL = register("molten_shovel",new ShovelItem(GlowingItem.MoltenToolMaterial.INSTANCE, 1.5F, -3.0F, new Item.Settings().group(UltimateUpgrade.UU_MAIN).fireproof()));
    public static final Item MOLTEN_SWORD = register("molten_sword",new SwordItem(GlowingItem.MoltenToolMaterial.INSTANCE, 3, -2.4F, new Item.Settings().group(UltimateUpgrade.UU_MAIN).fireproof()));
    public static final Item MOLTEN_PICKAXE = register("molten_pickaxe",new CustomPickaxeItem(GlowingItem.MoltenToolMaterial.INSTANCE, 1, -2.8F, new Item.Settings().group(UltimateUpgrade.UU_MAIN).fireproof()));
    ...
    public static final Item DRACONIC_TRIDENT = register("draconic_trident", new DraconicTridentItem(new FabricItemSettings().group(UltimateUpgrade.UU_MAIN).maxDamage(3000).customDamage(new DraconicCustomDamageHandler())));
    public static final Item DRACONIC_TOTEM = register("draconic_totem", new DraconicTotemItem(new FabricItemSettings().group(UltimateUpgrade.UU_MAIN).maxDamage(1).customDamage(new DraconicCustomDamageHandler())));
